...
### 🔧 What I'm Working On
- Playwright (TypeScript) + Appium (Python) automation framework for Yesdok
- CI/CD pipeline with GitHub Actions + Telegram bot notifications
- MVP scoping & PRD for Vila Booking product

### 🌱 Currently Leveling Up
- Test architecture & Page Object Model design
- Product Management — PRD writing, user flow, build tracking
- Mobile automation (iOS & Android) with Appium
...
- 🌐 Portfolio: <a href="https://bayuafriyadi5.github.io">bayuafriyadi5.github.io</a>
